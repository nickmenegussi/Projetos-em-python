    ...
    try:
        ...
        if opcao in 'Sairsair' or opcao in '3':
            ...
            if opcao != 'Sairsair' or opcao != '3':
                ...
                # 3.Inicio ao algoritmo
                    # ________________________________________________Computador jogou Pedra________________________________________________
                for opcoes in opcao:
                    if sorteador in 'Pedra': 
                        if opcao == '0':
                            linha()
                            linha()
                            print("\033[1;32mEMPATE!!\033[m")
                            ...
                            linha()
                            print(f"\033[1;32mComputador jogou: {sorteador}\033[m")
                            print(f"\033[1;32mJogador jogou: Papel\033[m")
                            linha()
                            print("\033[1;32mJOGADOR VENCEU!!\033[m")
                        elif opcoes in '2':
                            linha()
                            print(f"\033[1;32mComputador jogou: {sorteador}\033[m")
                            print(f"\033[1;32mJogador jogou: Tesoura\033[m")
                            linha()
                            print("\033[1;32mComputador VENCEU!!\033[m")
                        else:
                            print(f"\033[1;31mJogada invalida! nao temos o numero {opcoes}\033[m")
                    # ________________________________________________Computador jogou Papel________________________________________________
                for opcoes in opcao:
                    if sorteador in 'Papel':
                        if opcoes in '1':
                            linha()
                            print(f"\033[1;32mComputador jogou: {sorteador}\033[m")
                            print(f"\033[1;32mJogador jogou: Papel\033[m")
                            ...
                            print("\033[1;32mEMPATE!!\033[m")
                                ...
                                linha()
                                print(f"\033[1;32mComputador jogou: {sorteador}\033[m")
                                print(f"\033[1;32mJogador jogou: Pedra\033[m")
                                linha()
                                print("\033[1;32mCOMPUTADOR VENCEU!!\033[m")
                        elif opcoes in '2':
                                linha()
                            ...
                            print(f"\033[1;31mJogada invalida! nao temos o numero {opcoes}\033[m")
                    # ________________________________________________Computador jogou Tesoura________________________________________________
                for opcoes in opcao:
                    if  sorteador in 'Tesoura':
                        if opcoes in '2':
                            linha()
                            print(f"\033[1;32mComputador jogou: {sorteador}\033[m")
                            print(f"\033[1;32mJogador jogou: Tesoura\033[m")
